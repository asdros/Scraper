...
namespace Scraper.Services.Queries
{
    ...
    {
        public string AddItem => "INSERT INTO ScrapItem([Date],[Sunrise],[Sunset],[TempDay],[TempNight],[Pressure],[RainFall],[MoonPhase],[FishingQuality])" +
            " VALUES(@date,@sunrise,@sunset,@tempDay,@tempNight,@pressure,@rainFall,@moonPhase,@fishingQuality)";
        ...
        public string DropRows => "DELETE FROM ScrapItemp";
